...
model User {
  ...
  chef_reservations   Reservation[] @relation("ReservationChef")
...
model Facture {
  ...
  caissier              User        @relation(fields: [id_caissier], references: [id_user])
...
console.log('Schema prisma cree avec succes !');
